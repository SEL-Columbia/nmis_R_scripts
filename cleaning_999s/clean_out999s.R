...
cellst(merged_education,
    c('num_students_male','num_students_female',
      'num_students_total'),
    which(merged_education$num_students_male %in% c(9991, 99919)), NA_integer_) # 10300 stays

cellst(merged_education, 'num_pry_female',
     which(merged_education$num_pry_female > 20000), NA_integer_)
...
cellst(merged_education, 'num_toilet_boy',
  which(merged_education$num_toilet_boy > 9990), NA_integer_)
cellst(merged_education, 'num_toilet_girl',
      which(merged_education$num_toilet_girl > 9990), NA_integer_)
cellst(merged_education, 'num_toilet_both',
      which(merged_education$num_toilet_both > 9990), NA_integer_)
cellst(merged_education, 'num_tchrs_male',
      which(merged_education$num_tchrs_male > 9990), NA_integer_)
cellst(merged_education, 'num_tchrs_female',
      which(merged_education$num_tchrs_female > 9990), NA_integer_)
cellst(merged_education, 'num_math_textbook_js',
      which(merged_education$num_math_textbook_js > 5021000), NA_integer_)
cellst(merged_education, 'num_sr_staff_total',
      which(merged_education$num_sr_staff_total >= 990), NA_integer_)
...
cellst(merged_education, 'num_ss_female',
      which(merged_education$num_ss_female > 6000 ), NA_integer_)
...
cellst(merged_education, 'num_toilet_both',
      which(merged_education$num_toilet_both > 50 ), NA_integer_)
cellst(merged_education, 'num_tchrs_total',
      which(merged_education$num_tchrs_total > 5000 ), NA_integer_)
cellst(merged_education, 'num_sr_staff_total',
...
cellst(merged_health, 'medical_records_officers_active',
      which(merged_health$medical_records_officers_active > 980), NA_integer_)
...
cellst(merged_health, 'pharma_technicians_active',
      which(merged_health$pharma_technicians_active > 980), NA_integer_)
cellst(merged_health, 'pharmacists_active',
      which(merged_health$pharmacists_active > 980), NA_integer_)
cellst(merged_health, 'lab_technicians_active',
      which(merged_health$lab_technicians_active > 980), NA_integer_)
cellst(merged_health, 'pharmacists_active',
      which(merged_health$pharmacists_active > 980), NA_integer_)
...
cellst(merged_health, 'medical_records_officers_posted',
      which(merged_health$medical_records_officers_posted > 980), NA_integer_)
cellst(merged_health, 'pharma_technicians_posted',
      which(merged_health$pharma_technicians_posted > 980), NA_integer_)
...
cellst(merged_health, 'environmental_health_officers_posted',
      which(merged_health$environmental_health_officers_posted > 980), NA_integer_)
