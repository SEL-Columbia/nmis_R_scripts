...
cellst(merged_education, 'uniforms_fee',
       which(merged_education$uniforms_fee > 900000), NA_integer_) #one extreme value
...
cellst(merged_education,'num_sections_js1', 
       which(merged_education$num_sections_js1 >= 999), NA_integer_) # 8999 considered as typo of 9999
