...
edu_774 <- readRDS("~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Education_774_NMIS_Facility.rds")
edu_774_all <- readRDS("~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Education_774_ALL_FACILITY_INDICATORS.rds")

health_774 <- readRDS("~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Health_774_NMIS_Facility.rds")
health_774_all <- readRDS("~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Health_774_ALL_FACILITY_INDICATORS.rds")

water_774 <- readRDS("~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Water_774_NMIS_Facility.rds")
water_774_all <- readRDS("~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Water_774_ALL_FACILITY_INDICATORS.rds")
