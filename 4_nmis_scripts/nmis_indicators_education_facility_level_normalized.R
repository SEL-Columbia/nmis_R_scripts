...
edu_sub <- subset(edu_outlier , select=c("uuid", "lga", "state", 
                                         ...
                                         "num_students_total", "num_classrms_total", "num_classrm_w_chalkboard",
                                         "chalkboard_each_classroom_yn", "num_classrms_need_maj_repairs",
                                         "natl_curriculum_yn", "functional_water",
...
saveRDS(edu_sub, "~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Education_774_NMIS_Facility.rds")
saveRDS(e_774, "~/Dropbox/Nigeria/Nigeria 661 Baseline Data Cleaning/output_data/normalized/Education_774_ALL_FACILITY_INDICATORS.rds")
