...
$(N7)/Education$(L)_774.csv $(N7)/Education_774_$(NF) $(N7)/Health$(L)_774.csv $(N7)/Health_774_$(NF) $(N7)/Water$(L)_774.csv $(N7)/Water_774$(NF): $(N6)/Health_661_$(NF) $(N1)/Health_113_$(NF) $(NP)/Health_Pilot_$(NF) $(N6)/Health$(L)_661.csv $(N1)/Health$(L)_113.csv $(NP)/Health$(L)_Pilot.csv $(N6)/Education_661_$(NF) $(N1)/Education_113_$(NF) $(NP)/Education_Pilot_$(NF) $(N6)/Education$(L)_661.csv $(N1)/Education$(L)_113.csv $(NP)/Education$(L)_Pilot.csv $(n)COMBINING.R $(N6)/Water_661_$(NF) $(N1)/Water_113_$(NF) $(NP)/Water_Pilot_$(NF) $(N6)/Water$(L)_661.csv $(N1)/Water$(L)_113.csv $(NP)/Water$(L)_Pilot.csv $(n)COMBINING.R
...
# lga aggregations -- water -- 661 only
...
$(N6)/Water_661_$(NF) $(N6)/Water_661_$(AF): $(IN_PROC)/999cleaned/Water_661_999Cleaned_Reclassified.csv $(n)water$(f).R

# facility indicators -- health -- pilot
$(NP)/Health_Pilot_$(NF) $(NP)/Health_Pilot_$(AF): $(n)health$(f)_pilot.R $(RAW_DATA)/113/Educ_Baseline_PhaseII_all_merged_cleaned_2011Nov21.csv $(RAW_DATA)/113/Pilot_Data_Health_Clean_2011.11.18.csv
	$(R) $(n)health$(f)_pilot.R  /dev/tty
# facility indicators -- health -- 113
$(N1)/Health_113_$(NF) $(N1)/Health_113_$(AF): $(n)health$(f)_113.R $(RAW_DATA)/113/Educ_Baseline_PhaseII_all_merged_cleaned_2011Nov21.csv $(RAW_DATA)/113/Pilot_Data_Health_Clean_2011.11.18.csv
...
$(NP)/Education_Pilot_$(NF) $(NP)/Education_Pilot_$(AF): $(n)education$(f)_pilot.R $(RAW_DATA)/113/Educ_Baseline_PhaseII_all_merged_cleaned_2011Nov21.csv $(RAW_DATA)/113/Pilot_Education_cleaned_2011Nov17.csv 
	$(R) $(n)education$(f)_pilot.R
# facility indicators -- education -- 113
$(N1)/Education_113_$(NF) $(N1)/Education_113_$(AF): $(n)education$(f)_113.R $(RAW_DATA)/113/Educ_Baseline_PhaseII_all_merged_cleaned_2011Nov21.csv $(RAW_DATA)/113/Pilot_Education_cleaned_2011Nov17.csv 
