...
health_999$improved_sanitation_and_functional[health_999$src == '113'] <- 
                                             (health_999$toilet_types_vip_latrine[health_999$src == '113'] | 
                                               ...
                                               (health_999$num_flush_or_pour_flush_piped[health_999$src == '113'] & 
                                                  health_999$flush_toilet_drain_to[health_999$src == '113'] == 'improved')) & 
                                            ((health_999$toilet_types_vip_latrine[health_999$src == '113'] & 
                                                (health_999$vip_latrine_not_working[health_999$src == '113'] < 7)) | 
                                               (health_999$toilet_types_pit_w_slab[health_999$src == '113'] & 
                                                  (health_999$slab_pit_latrine_not_working[health_999$src == '113']) < 7) | 
                                               (health_999$num_flush_or_pour_flush_piped[health_999$src == '113'] & 
                                                  health_999$flush_toilet_drain_to[health_999$src == '113'] == 'improved' & 
                                                  (health_999$flush_toilet_not_working[health_999$src == '113'] < 7)))

health_999$power_access_and_functional[health_999$src == '113'] <- (((health_999$power_sources_generator[health_999$src == '113'] &
                                        ...
                                        (health_999$days_no_electricity[health_999$src == '113'] <= 7))

health_999$power_access_and_functional[health_999$src == 'pilot'] <- 
                                        (((health_999$power_sources_generator[health_999$src == 'pilot'] &
                                          ...
                                          (health_999$days_no_electricity[health_999$src == 'pilot']) <= 7)
