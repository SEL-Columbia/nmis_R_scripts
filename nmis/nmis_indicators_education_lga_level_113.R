...
##113###########################################################################################
################################################################################################
ed <- read.csv("in_process_data/nmis/data_113/Education_113_ALL_FACILITY_INDICATORS.csv", stringsAsFactor=F)
e <- ed
...
#writing out
write.csv(lga_education_all, "in_process_data/nmis/data_113/Education_LGA_level_113.csv", row.names=F)
