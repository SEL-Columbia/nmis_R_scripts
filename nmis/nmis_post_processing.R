...
percent_names <- c("proportion_schools_power_access_primary", "proportion_health_facilities_hiv_testing", 
                   ...
                   "transition_rate_primary_to_js1_female", "net_enrollment_ratio_secondary_education", 
                   "proportion_schools_gender_sep_toilet_juniorsec", "proportion_schools_gender_sep_toilet_primary", 
                   "gross_enrollment_ratio_secondary_education", "proportion_health_facilities_inpatient_care", 
                   ...
                   "literacy_rate", "net_enrollment_ratio_primary_education", "proportion_delivery_no_user_fees", 
                   "proportion_growth_monitoring", "proportion_schools_with_first_aid_kit_primary", 
                   "proportion_no_user_fees_malaria", "gross_enrollment_ratio_primary_education", 
